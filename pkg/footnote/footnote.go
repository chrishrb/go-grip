...
func NewFootnoteConfig() FootnoteConfig {
	return FootnoteConfig{
		...
		BacklinkClass: []byte("data-footnote-backref"),
		BacklinkHTML:  []byte("↩"),
	}
}
...
func (r *FootnoteHTMLRenderer) renderFootnoteBacklink(
	...
	if entering {
		...
		_, _ = w.WriteString(`" role="doc-backlink" data-footnote-backref>`)
